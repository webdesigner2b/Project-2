...
export const footerData = {
    topSection: {
        columns: [
            { columnTitle: 'Overview', list: ['Home Page', 'Banks', 'About us', 'Contact us'] },
            { columnTitle: 'PRODUCTS', list: ['Personal Finance', 'Machine Learning'] },
    ...
    bottomSection: {
        ...
        socialSection: {
            ...
            socialMediaIcons: [
                ...
                { icon: discordIcon, link: 'https://discord.gg/e2X5mNzqwG' },
            ]
        }
    }
}
